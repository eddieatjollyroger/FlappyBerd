package com.hackathon.GameWorld;
...
import com.hackathon.GameObjects.Grass;
import com.hackathon.GameObjects.Pipe;
import com.hackathon.GameObjects.ScrollHandler;
...
public class GameRenderer {
	...
	private void drawPipes() {
		...
		batcher.draw(bar, pipe1.getX(), pipe1.getY() + pipe1.getHeight() + 45,
				pipe1.getWidth(), midPointY + 65 - (pipe1.getHeight() + 45));

		batcher.draw(bar, pipe2.getX(), pipe2.getY(), pipe2.getWidth(),
				pipe2.getHeight());
		batcher.draw(bar, pipe2.getX(), pipe2.getY() + pipe2.getHeight() + 45,
				pipe2.getWidth(), midPointY + 65 - (pipe2.getHeight() + 45));

		batcher.draw(bar, pipe3.getX(), pipe3.getY(), pipe3.getWidth(),
				pipe3.getHeight());
		batcher.draw(bar, pipe3.getX(), pipe3.getY() + pipe3.getHeight() + 45,
				pipe3.getWidth(), midPointY + 65 - (pipe3.getHeight() + 45));
	}
	...
	public void render(float runTime) {
		...
		if (myWorld.isReady()) {
			// Draw shadow first
			AssetLoader.shadow.draw(batcher, " Touch\n screen", (136 / 2) - (42), 76);
			// Draw text
			AssetLoader.font
					.draw(batcher, " Touch\n screen", (136 / 2) - (42 - 1), 75);
		} else {
